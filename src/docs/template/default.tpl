...
<div class="container">
    ...
    <footer class="footer footer--main">
        <!-- <p class="footer__text">Generated by <a href="http://daux.io" target="_blank" class="link link--footer">Daux.io</a></p> -->
        <p class="footer__text">Generated on <?php echo date('Y-m-d H:i:s'); ?><br>Modified on <?php echo date('Y-m-d H:i:s', $page["modified"]); ?></p>
    </footer>
</div>
